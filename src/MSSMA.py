...
# ## Results
# %% [markdown]
# The above process simulates the load-wash-elute (LWE) CEX under overloaded conditions with a mAb feed concentration of 118.2 g/L = 0.106 mM ([3.2. Model calibration](https://www.sciencedirect.com/science/article/pii/S002196731731381X?via%3Dihub#sec0075)). The salt and protein concentrations of the inlet during every step of the LWE are specified using `events`. A linear salt gradient is implemented for elution. The process protocol is taken from [Table A1](https://www.sciencedirect.com/science/article/pii/S002196731731381X?via%3Dihub#tbl0020).
#
